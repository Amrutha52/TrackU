...
import com.happy.ecofied.gson.dailywisegpsdatajsondetails.DailyWiseGPSDataJson;
import com.happy.ecofied.gson.dailywisegpsdatajsondetails.DailyWiseGPSDataResponsestatus;
import com.happy.ecofied.models.events.BeginJourneyEvent;
import com.happy.ecofied.models.events.CurrentJourneyEvent;
import com.happy.ecofied.models.events.EndJourneyEvent;
import com.happy.ecofied.models.events.JourneyEventBus;
import com.happy.ecofied.models.events.Result;
import com.happy.ecofied.ssl.CustomTrust;
import com.happy.ecofied.utils.ApiInterface;
import com.happy.ecofied.utils.Common;
import com.happy.ecofied.utils.Const;
import com.happy.ecofied.utils.IGoogleApi;
  ...
  */
   ...
   */
    ...
    private void drawPolyline(Result result) {
        ...
        List<com.happy.ecofied.models.events.Route> routes = result.getRoutes();
        if (routes != null && !routes.isEmpty()) {
            List<com.happy.ecofied.models.events.Leg> legs = routes.get(0).getLegs();
            if (legs != null && !legs.isEmpty()) {
                List<com.happy.ecofied.models.events.Step> steps = legs.get(0).getSteps();
                for (com.happy.ecofied.models.events.Step step : steps) {
