...
import com.happy.ecofied.gson.purchaseorderitemlist.Data;
...
public class DbHelper extends SQLiteOpenHelper
{
    ...
    {
        SQLiteDatabase db = this.getWritableDatabase();
        com.happy.ecofied.gson.stockoutpurchaseorderitemlist.Data data = stockOutPurchaseOrderItemListJson.getData();
