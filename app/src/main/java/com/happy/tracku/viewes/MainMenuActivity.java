        ...
        if (requestCode == PERMISSION_REQUEST_ID) {
            if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
               ...
               // Toast.makeText(this, "Location permission is required for this feature.", Toast.LENGTH_LONG).show();
                //Fns.neutralAlert("Alert","Location permission is required for this feature.Please turnon the location to access app functioning activities", this);

                AlertDialog.Builder adb = new AlertDialog.Builder(this);

                TextView titletxtview = new TextView(this);
                titletxtview.setText("Alert");
                titletxtview.setBackgroundColor(ContextCompat.getColor(this, R.color.colorPrimary));
                ...
                TextView messagetxtview = new TextView(this);
                messagetxtview.setText("Location permission is required for this feature.Please turnon the location to access app functioning activities..");
